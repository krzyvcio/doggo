...
var JwtRefreshGuard = /** @class */ (function (_super) {
    ...
    JwtRefreshGuard.prototype.canActivate = function (context) {
        // Add your custom authentication logic here
        // for example, call super.logIn(request) to establish a session.
        return _super.prototype.canActivate.call(this, context);
    };
    // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types
    JwtRefreshGuard.prototype.handleRequest = function (err, user, info) {
...
}((0, passport_1.AuthGuard)(strategy_constant_1.STRATEGY_JWT_REFRESH)));
