...
describe('AuthController', () => {
    ...
    describe('registerLocal', () => {
        it('should register new user', async () => {
            ...
            jest.spyOn(mockedAuthService, 'register').mockImplementation(
                async () => null,
            );

            expect(
                await authController.registerLocal(ctx, registerInputDto),
            ).toEqual({
                data: null,
                meta: {},
            });
    ...
    describe('login', () => {
        it('should login user', async () => {
            ...
            jest.spyOn(mockedAuthService, 'login').mockImplementation(
                () => null,
            );
    ...
    describe('refreshToken', () => {
        ...
        beforeEach(() => {
            ...
            jest.spyOn(mockedAuthService, 'refreshToken').mockImplementation(
                async () => authToken,
            );
        });
