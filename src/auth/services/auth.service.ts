...
export class AuthService {
    ...
    async registerSuperAdmin(
        ...
        this.logger.log(ctx, `${this.registerSuperAdmin.name} was called`);
    ...
    async deleteUser(ctx: RequestContext, id: number): Promise<boolean> {
        this.logger.log(ctx, `${this.deleteUser.name} was called`);

        return await this.userService.deleteUser(ctx, id);
    }
}
