...
exports.databaseProviders = exports.DatabaseProviders = void 0;
var common_1 = require("@nestjs/common");
var config_1 = require("@nestjs/config");
var typeorm_1 = require("typeorm");
var DatabaseProviders = /** @class */ (function () {
    function DatabaseProviders() {
    }
    DatabaseProviders = __decorate([
...
exports.databaseProviders = [
    {
        ...
        dataSourceFactory: function (options) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, new typeorm_1.DataSource(options).initialize()];
                    case 1:
                        dataSource = _a.sent();
