...
var email_change_controller_1 = require("./email-change.controller");
var email_change_service_1 = require("./email-change.service");
var EmailChangeModule = /** @class */ (function () {
    function EmailChangeModule() {
    }
    EmailChangeModule = __decorate([
        (0, common_1.Module)({
