...
export class TripLocationHistoryController {
  constructor(private readonly tripLocationHistoryService: TripLocationHistoryService) {
  }
  ...
  @Patch(":id")
  update(@Param("id") id: string, @Body() updateTripLocationHistoryDto: UpdateTripLocationHistoryDto) {
