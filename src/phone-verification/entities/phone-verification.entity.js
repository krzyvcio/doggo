...
var PhoneVerification = /** @class */ (function () {
    ...
    ], PhoneVerification.prototype, "id");
    __decorate([
        (0, typeorm_1.Column)("varchar", { length: 6 })
    ], PhoneVerification.prototype, "code");
    __decorate([
        (0, typeorm_1.Column)()
    ], PhoneVerification.prototype, "userId");
    __decorate([
        (0, typeorm_1.OneToOne)(function () { return user_entity_1.User; }, function (user) { return user.id; }, { onDelete: "CASCADE" })
    ], PhoneVerification.prototype, "user");
    __decorate([
        (0, typeorm_1.Column)()
    ], PhoneVerification.prototype, "validUntil");
    __decorate([
        (0, typeorm_1.Column)({ "default": false })
    ], PhoneVerification.prototype, "isVerification");
    __decorate([
    ...
    ], PhoneVerification.prototype, "createdAt");
    __decorate([
    ...
    ], PhoneVerification.prototype, "modifiedAt");
    PhoneVerification = __decorate([
        (0, typeorm_1.Entity)("phoneVerification")
    ], PhoneVerification);
