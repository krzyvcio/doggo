...
var request_context_dto_1 = require("./shared/request-context/request-context.dto");
var user_service_1 = require("./user/services/user.service");
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, defaultAdminUserPassword, userService, defaultAdmin, ctx, user;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    ctx = new request_context_dto_1.RequestContext();
                    return [4 /*yield*/, userService.findByUsername(ctx, defaultAdmin.username)];
                case 2:
                    user = _a.sent();
                    if (!!user) return [3 /*break*/, 4];
                    return [4 /*yield*/, userService.createUser(ctx, defaultAdmin)];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4: return [4 /*yield*/, app.close()];
                case 5:
                    _a.sent();
                    return [2 /*return*/];
            }
